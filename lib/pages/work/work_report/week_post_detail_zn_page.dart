...
///周报详情(职能)
class WeekPostDetailZNPage extends StatefulWidget {
  final HomeReportModel model;
  final Color themColor;
  const WeekPostDetailZNPage({Key key, @required this.model, @required this.themColor}) : super(key: key);

  @override
  _WeekPostDetailZNPageState createState() => _WeekPostDetailZNPageState();
}

class _WeekPostDetailZNPageState extends State<WeekPostDetailZNPage> {
  String _position = '';
  String _area = '';
        ...
        child: CustomScrollView(
          slivers: [
            ...
            PostDetailHeaderView(
                ...
                area: _area),
            //本周工作内容
            PostDetailGroupTitle(color: widget.themColor, name: '本周工作内容'),
            PostDetailPlanList(list: widget.model.summary),
            //本周工作中存在的问题及需改进的方面
            PostDetailGroupTitle(color: widget.themColor, name: '本周工作中存在的问题及需改进的方面'),
            PostDetailPlanList(list: _problems),
            //下周工作计划
            PostDetailGroupTitle(color: widget.themColor, name: '下周工作计划'),
