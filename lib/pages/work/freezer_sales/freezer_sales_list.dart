        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(data['region'],style: TextStyle(fontSize: 12, color: Color(0XFF959EB1))),
            ),
            //标题头部
            Padding(
              padding: EdgeInsets.all(10.0),
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 3),
                      Text(data['address'], style: TextStyle(fontSize: 12, color: Color(0XFF959EB1)))
                    ],
                  ),
                  Container(
                    ...
                    child: Column(
                      children: [
                        Text(data['number'], style: TextStyle(fontSize: 15, color: Color(0XFFE45C26))),
